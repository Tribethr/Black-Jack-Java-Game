/**
 * Librería para el maneja de intefaz
 * 
...
public abstract class UiFrame extends JFrame{
  ...
  public UiFrame(String pTitulo, int x, int y, int ancho, int alto) {
	...
	/**
	 * Crea un label
	 * @param texto que mostrará el label
	 * @param coordenada x donde se posicionará el label
	 * @param coordenada y donde se posicionará el label 
	 * @param ancho del label
	 * @param alto del label
	 * @param tamaño de la fuente del label
	 * @return label creado
	 */
   ...
   * @param coordena x donde se ubicará el cuadro de texto
   * @param coordena y donde se ubicará el cuadro de texto
   * @param ancho del cuadro de texto
   * @param alto del cuadro de texto
   * @param tamaño de la fuente del cuadro de texto
   ...
   * @param coordena x donde se ubicará el boton
   * @param coordena y donde se ubicará el boton
   * @param ancho del boton
   * @param alto del boton
   * @param tamaño de la fuente del boton
   * @return boton creado
   */
   ...
   * @param True si el cuadro a tener multiples opciones o False si es solo un objeto de selección
   ...
   * @param coordena x donde se ubicará el listado
   * @param coordena y donde se ubicará el listado
   * @param ancho del listado
   * @param alto del listado
   * @param tamaño de la fuente del listado
  ...
  public JTextArea crearListado(String pregunta,int x,int y,int ancho,int alto, int tamannoFuente) {
	 ...
	 * @param coordena x donde se ubicará el cuadro
   * @param coordena y donde se ubicará el cuadro
   * @param ancho del cuadro
   * @param alto del cuadro
   * @param tamaño de la fuente del cuadro
	 * @return cuadro de texto creado
	 */
